...
const document = {documentElement:{lang:'zh-CN'},addEventListener:()=>{}};
...
vm.runInNewContext(source,{window,document,location,URLSearchParams,Promise});
...
assert.equal(captured.length,n+2);
window.zaraz=null;
