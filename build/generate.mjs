...
.topbar{display:flex;align-items:center;gap:24px;flex-wrap:nowrap;padding:0 0 12px;margin:0 0 14px}
...
.nav{display:flex;gap:14px;align-items:center;flex-wrap:nowrap;line-height:1;min-height:0;height:auto}
