...
const LEGAL_HTML = {
  ...
  zh: {
    privacy: {
      ...
      body: `<h1>隐私政策</h1><p class="intro">最近审阅：2026-08-14</p><h3>我们是谁</h3><p>本政策说明 FeeEye（"我们"）如何处理本网站的信息。</p><h3>我们收集什么</h3><ul><li><b>工具输入：</b>你在计算器里输入的金额、入金方式等只在你的浏览器内处理，绝不会上传或存储到我们服务器。</li><li><b>分析：</b>我们使用注重隐私的聚合分析（页面浏览量）来了解流量，不收集可识别个人身份的数据，IP 地址尽可能匿名化。</li><li><b>返佣链接：</b>点击返佣链接时，交易所会在其自身域名下设置推荐 cookie。我们无法控制这一点，详见各交易所的隐私政策。</li></ul><h3>我们不收集什么</h3><p>我们不要求注册账号，不收集姓名、邮箱等个人数据，不出售个人数据。</p><h3>Cookie</h3><p>我们仅使用少量分析 cookie。你可以在浏览器中禁用，不影响核心工具功能。</p><h3>你的权利</h3><p>根据你所在司法辖区（如 EEA/英国居民的 GDPR），你可要求访问、更正或删除我们持有的个人数据。联系：<a href="mailto:feeeyeofficial@gmail.com">feeeyeofficial@gmail.com</a>。</p><h3>变更</h3><p>实践发生变化时，我们会更新本政策及"最近审阅"日期。</p>`
    },
    terms: {
      title: '使用条款',
