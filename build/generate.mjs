...
.trust-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:10px;max-width:780px;margin:14px auto 18px;grid-auto-rows:minmax(60px,auto);align-items:stretch}
